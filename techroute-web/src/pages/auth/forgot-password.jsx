...
const ForgotPasswordPage = () => {
  ...
  return (
    <div className="min-h-screen w-full flex justify-center items-center bg-white p-6 font-sans">
      <div className="relative flex flex-col justify-center items-center gap-5 border p-18 pb-7 md:pb-12  md:p-24 scale-65 sm:scale-100 rounded-[11px] border-gray-200 shadow-[0_0_24px_rgba(0,0,0,0.06)]">
        ...
        <h1 className="text-2xl md:text-3xl whitespace-nowrap font-bold text-[#00C3FF] text-center -mt-10">
          Forgot your password ?
        </h1>
        <span className="text-gray-500 text-xm mb-3">Type your email for reset</span>
        <form onSubmit={handleReset} className="w-[130%] flex flex-col items-center justify-center gap-10">
          <input
            type="email"
