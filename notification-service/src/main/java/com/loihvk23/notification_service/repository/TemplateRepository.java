...
public interface TemplateRepository extends MongoRepository<TemplateDocument, String> {
	...
	Optional<TemplateDocument> findByTemplateKeyContaining(String templateKey);

	Optional<TemplateDocument> findByOwnerEmailAndTemplateKeyContaining(String ownerEmail, String templateKey);
