      ...
      <div className="w-full overflow-y-auto max-h-[calc(100vh-260px)] pr-2 flex flex-col gap-6 custom-scrollbar">
        <div className="flex flex-col gap-2.5">
          <div className="flex items-center gap-2">
            <span className="w-6 h-6 rounded-md bg-blue-50 text-[#1677FF] flex items-center justify-center font-bold text-xs">
              1
            </span>
            <h3 className="text-sm font-bold text-[#1677FF] underline underline-offset-4">
