package com.loihvk23.auth_service.exception;
...
import com.loihvk23.auth_service.dto.response.ErrorResponse;
...
public class GlobalHandlerException {
	...
	public ResponseEntity<ErrorResponse<Map<String, String>>> handleValidationException(MethodArgumentNotValidException exp) {
	...
	public ResponseEntity<ErrorResponse<String>> handleNotFoundResoucesException(NoResourceFoundException exp) {
		...
		ErrorResponse<String> errorResponse = ErrorResponse.<String>builder()
				...
				.status(HttpStatus.NOT_FOUND.value())
				.error(HttpStatus.NOT_FOUND.getReasonPhrase())
				.message("The requested resources do not exist., please try again later !!")
				.build();
	...
	public ResponseEntity<ErrorResponse<String>> handleGlobalException(Exception exp) {
		...
		ErrorResponse<String> errorResponse = ErrorResponse.<String>builder()
				...
				.message("The system has encountered an unexpected issue, please try again later !!")
				.build();
